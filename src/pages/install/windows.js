          ...
          <Grid.Column width={13}>
            ...
            <Table structured inverted padded>
              ...
              <Table.Row>
                <Table.Cell rowspan='2'>1</Table.Cell>
                <Table.Cell>
                  首先點擊這裏下載最新版的漢語方言拼音方案合集，打開壓縮包可以看到裏面有一個<code>default.custom.yaml</code>和<code>default.yaml</code>文件（這兩個文件是給其他平臺用戶的，我們Windows忽略它就行了）和以各大方言區命名的文件夾。
                </Table.Cell>
              </Table.Row>
              <Table.Row>
                <Table.Cell>
            ...
            <Table inverted structured padded>
              ...
              <Table.Row>
                <Table.Cell>
                  <Image src='/win/win_c1_1.png'></Image>
                </Table.Cell>
              </Table.Row>
              <Table.Row>
                <Table.Cell rowspan='2'>2</Table.Cell>
              ...
              <Table.Row>
                <Table.Cell>
                  <Image src='/win/win_c1_2.png' fluid></Image>
                </Table.Cell>
              </Table.Row>
              <Table.Row>
                <Table.Cell rowspan='2'>3</Table.Cell>
              ...
              <Table.Row>
                <Table.Cell>
                  <Image src='/win/win_c1_3.png' fluid></Image>
                </Table.Cell>
              </Table.Row>
              <Table.Row>
                <Table.Cell rowspan='2'>4</Table.Cell>
              ...
              <Table.Row>
                <Table.Cell>
                  <Image src='/win/win_c1_4.png' fluid></Image>
                </Table.Cell>
              </Table.Row>
              <Table.Row>
                <Table.Cell rowspan='2'>5</Table.Cell>
              ...
              <Table.Row>
                <Table.Cell>
                  <Image src='/win/win_c1_6.png' fluid></Image>
                </Table.Cell>
              </Table.Row>
            </Table>
            <Header size="large" as="h3">
            ...
            <Table inverted structured padded>
              ...
              <Table.Row>
                <Table.Cell>
                  <Image src='/win/win_c1_1.png' size='medium' fluid></Image>
                </Table.Cell>
              </Table.Row>
              <Table.Row>
                <Table.Cell rowspan='2'>2</Table.Cell>
              ...
              <Table.Row>
                <Table.Cell>
                  <Image src='/win/win_c2_2.png' fluid></Image>
                </Table.Cell>
              </Table.Row>
              <Table.Row>
                <Table.Cell rowspan='2'>3</Table.Cell>
              ...
              <Table.Row>
                <Table.Cell>
                  <Image src='/win/win_c2_3.png' fluid></Image>
                </Table.Cell>
              </Table.Row>
              <Table.Row>
                <Table.Cell rowspan='2'>4</Table.Cell>
              ...
              <Table.Row>
                <Table.Cell>
                  <Image src='/win/win_c2_4.png' fluid></Image>
                </Table.Cell>
              </Table.Row>
              <Table.Row>
                <Table.Cell rowspan='2'>5</Table.Cell>
              ...
              <Table.Row>
                <Table.Cell>
                  <Image src='/win/win_c2_6.png' fluid></Image>
                </Table.Cell>
              </Table.Row>
            </Table>
